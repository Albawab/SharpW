...
namespace Import.Mockups
{
    ...
    public class InternalMenubarFileShowInGrid : IMenubarSevice
    {
        ...
        private List<MenubarItemModel> GetItems()
        {
            ...
            {
                new MenubarDialogModel(0, "Inlezen") { Kinderen = new List<MenubarItemModel>() { new MenubarUploadFileModel(0, "Upload file"), new DialogButtonModel(1, "OK") } },
                new MenubarButtonModel(1, "Verwerken"),
            };
        }
    }
}
