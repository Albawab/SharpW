    ...
    { /// <summary>
      ...
      /// <param name="configuration">configuration.</param>
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<INavigatieService>(new InternalNavigatieGridOdataService());
            services.AddSingleton<IMenubarSevice>(new InternalToolsMenuClientsService());
            services.AddSingleton<IAppService>(new InternalApiService());
